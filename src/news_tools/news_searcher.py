...
class NewsSearcher:
    ...
    CATEGORY_KEYWORDS = {
        ...
        'finance': ['财经', '金融', '股票', '经济', 'finance', 'economy', 'stock'],
        'crypto': ['加密货币', '比特币', '以太坊', 'crypto', 'bitcoin', 'ethereum'],
        'blockchain': ['区块链', 'blockchain', 'web3', 'defi'],
        'fengshui': ['风水', '玄学', '命理', 'fengshui', 'metaphysics'],
        'tech': ['科技', '技术', 'AI', 'technology', 'artificial intelligence'],
        'social': ['社会', '生活', '娱乐', 'social', 'entertainment', 'lifestyle'],
        'international': ['国际', '世界', '全球', 'international', 'world', 'global']
    }
